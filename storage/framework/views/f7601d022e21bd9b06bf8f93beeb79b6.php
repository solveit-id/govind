  ...
  <body class="flex items-center justify-center min-h-screen px-4">
    ...
    >
        ...
        >
            ...
            <a href="<?php echo e(url('/login')); ?>" class="font-semibold text-[#285E5E] hover:underline">
                Sign in now
            </a>
            </p>
        </form>
...
<?php /**PATH D:\PROJEK\PROJEK SOLVE IT\WEB\govind\resources\views/auth/register.blade.php ENDPATH**/ ?>